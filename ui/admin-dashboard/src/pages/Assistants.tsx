...
export default function AssistantsPage() {
    ...
    const addPluginMutation = useMutation({
        mutationFn: async (p: { assistantId: string; pluginId: string }) => addPluginToAssistant(p.assistantId, p.pluginId),
        onSuccess: async () => {
    ...
    const removePluginMutation = useMutation({
        mutationFn: async (p: { assistantId: string; pluginId: string }) => removePluginFromAssistant(p.assistantId, p.pluginId),
        onSuccess: async () => {
    ...
    return (
        <div className="space-y-10 relative" > {/* Increased space-y for better vertical spacing */}
            <PageHeader
            ...
            <div className="flex items-center justify-start gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button
                        ...
                        onClick={() => selectedPluginIdToAdd && onAddPlugin(selectedPluginIdToAdd)}
                    >

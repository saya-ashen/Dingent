...
import { ThreadContextType, ChatThread } from "@repo/types"; // Import from types file
...
export const useThreadContext = () => {
  ...
  if (!context) {
    throw new Error(
      "useThreadContext must be used within a ThreadProvider (in Providers component)",
    );
  }
  return context;
};

    ...
    <SidebarGroup>
      ...
      <SidebarMenu>
        {items.map((item) => {
          ...
          // --- MODIFIED LOGIC ---
          // 3. Only render the conditional part if we are on the client
          return isClient ? (
            ...
            // 4. Render a consistent, non-conditional version on the server
            //    (and during the initial client render before useEffect runs).
            //    This collapsible version is a safe default.
            <SidebarMenuCollapsible key={key} item={item} href={pathname} />
          );
        })}
      </SidebarMenu>

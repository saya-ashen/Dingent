...
const config: Config = {
    title: 'Dingent',
    tagline: 'A lightweight, user-friendly LLM Agent framework focused on simplifying data retrieval application development.',
    ...
    projectName: 'Dingent', // Usually your repo name.
    trailingSlash: false,
            ...
            links: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: 'Github Issue',
                            href: 'https://github.com/saya-ashen/Dingent/issues',
                        },
                    ],
                },
                {

...
class Actor(SQLModel, table=True):
    ...
    """
    actor_id: int | None = Field(
        primary_key=True, description="Unique identifier for the actor."
    )
...
class Category(SQLModel, table=True):
    ...
    category_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the category."
    )
...
class Language(SQLModel, table=True):
    ...
    language_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the language."
    )
...
class Film(SQLModel, table=True):
    ...
    film_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the film."
    )
    ...
    release_year: int | None = Field(
        default=None, alias="Release Year", description="The year the film was released."
    )
    language_id: int = Field(
        foreign_key="language.language_id", description="Identifier for the film's language."
    )
    ...
    rental_rate: float = Field(
        default=4.99, alias="Rental Rate", description="The cost to rent the film."
    )
    length: int | None = Field(
        default=None, alias="Length (min)", description="The duration of the film in minutes."
    )
...
class Country(SQLModel, table=True):
    ...
    country_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the country."
    )
...
class City(SQLModel, table=True):
    ...
    city_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the city."
    )
    city: str = Field(alias="City", description="The name of the city.")
    country_id: int = Field(
        foreign_key="country.country_id", description="Identifier for the associated country."
    )
    last_update: datetime.datetime | None = Field(
        alias="Last Update",
        description="Timestamp of the last update to this record.",
...
class Address(SQLModel, table=True):
    ...
    address_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the address."
    )
...
class Store(SQLModel, table=True):
    ...
    store_id: int | None = Field(
        default=None, primary_key=True, description="Unique identifier for the store."
    )
